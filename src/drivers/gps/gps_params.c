 ...
 * @group GPS
 */
PARAM_DEFINE_INT32(GPS_UBX_GPS_MIN_CHANNELS, -1);
 ...
 * @group GPS
 */
PARAM_DEFINE_INT32(GPS_UBX_GPS_MAX_CHANNELS, -1);
 ...
 * @group GPS
 */
PARAM_DEFINE_INT32(GPS_UBX_ENABLE_GPS_QZSS, 1);
 ...
 * @group GPS
 */
PARAM_DEFINE_INT32(GPS_UBX_ENABLE_SBAS, 1);
 ...
 * @group GPS
 */
PARAM_DEFINE_INT32(GPS_UBX_ENABLE_GLONASS, 1);
