...
init_activity_config_list(){
    ...
    {0,0,0,0,5,10,12,1,0,20,0,1,1.2,0,2,6,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,4,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15},
