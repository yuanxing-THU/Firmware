...
init_allowed_params() {
    ...
    ALLOWED_PARAMS[20] = AllowedParam(20,   "FOL_FF_GRAD_STRT",     DOG, "",    "Gradient START",   DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[21] = AllowedParam(21,   "FOL_FF_GRAD_END",      DOG, "",    "Gradient END",     DISPLAY_VALUES_EMPTY);
    ...
    ALLOWED_PARAMS[24] = AllowedParam(24,   "INAV_INIT_EPH",        DOG, "",    "INAV INIT EPH",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[25] = AllowedParam(25,   "INAV_INIT_EPV",        DOG, "",    "INAV INIT EPV",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[26] = AllowedParam(26,   "INAV_INIT_WAIT",       DOG, "",    "INAV INIT WAIT",   DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[27] = AllowedParam(27,   "MPC_PITCH_LPF",        DOG, "",    "MPC PITCH LPF",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[28] = AllowedParam(28,   "MPC_XY_FF",            DOG, "",    "MPC XY FF",        DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[29] = AllowedParam(29,   "MPC_XY_P",             DOG, "",    "MPC XY P",         DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[30] = AllowedParam(30,   "MPC_XY_VEL_D",         DOG, "",    "MPC XY VEL D",     DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[31] = AllowedParam(31,   "MPC_XY_VEL_I",         DOG, "",    "MPC XY VEL I",     DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[32] = AllowedParam(32,   "MPC_XY_VEL_MAX",       DOG, "",    "MPC XY VEL MAX",   DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[33] = AllowedParam(33,   "MPC_XY_VEL_P",         DOG, "",    "MPC XY VEL P",     DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[34] = AllowedParam(34,   "MPC_Z_FF",             DOG, "",    "MPC Z FF",         DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[35] = AllowedParam(35,   "MPC_Z_P",              DOG, "",    "MPC Z P",          DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[36] = AllowedParam(36,   "MPC_Z_VEL_D",          DOG, "",    "MPC Z VEL D",       DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[37] = AllowedParam(37,   "MPC_Z_VEL_I",          DOG, "",    "MPC Z VEL I",      DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[38] = AllowedParam(38,   "MPC_Z_VEL_MAX",        DOG, "",    "MPC Z VEL MAX",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[39] = AllowedParam(39,   "MPC_Z_VEL_P",          DOG, "",    "MPC Z VEL P",      DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[40] = AllowedParam(40,   "PAFOL_GT_AC_DST",      DOG, "",    "PAFOL GT AC DST",  DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[41] = AllowedParam(41,   "SDLOG_ON_BOOT",        DOG, "",    "SDLOG ON BOOT",    DISPLAY_VALUES_ON_OFF);
    ALLOWED_PARAMS[42] = AllowedParam(42,   "SENS_SON_ON",          DOG, "",    "SENS SON ON",      DISPLAY_VALUES_ON_OFF);
    ALLOWED_PARAMS[43] = AllowedParam(43,   "UBX_ENABLE_SBAS",      DOG, "",    "UBX ENABLE SBAS",  DISPLAY_VALUES_YES_NO);
    ALLOWED_PARAMS[44] = AllowedParam(44,   "UBX_GPS_MAX_CHN",      DOG, "",    "UBX GPS MAX CHN",  DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[45] = AllowedParam(45,   "UBX_GPS_MIN_CHN",      DOG, "",    "UBX GPS MAX CHN",  DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[46] = AllowedParam(46,   "INAV_W_Z_GPS_P",       DOG, "",    "INAV W Z GPS P",   DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[47] = AllowedParam(47,   "INAV_W_Z_BARO",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[48] = AllowedParam(48,   "NAV_CP_FIR_AL",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[49] = AllowedParam(49,   "NAV_CP_FIR_LA",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[50] = AllowedParam(50,   "NAV_CP_FIR_LO",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[51] = AllowedParam(51,   "NAV_CP_LAS_AL",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[52] = AllowedParam(52,   "NAV_CP_LAS_LA",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[53] = AllowedParam(53,   "NAV_CP_LAS_LO",        DOG, "",    "INAV W Z BARO",    DISPLAY_VALUES_EMPTY);
