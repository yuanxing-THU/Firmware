...
ParamLimits::ParamLimits(const char * _name, int _type, int _target_device, float _istart, float _iend, float _step, std::initializer_list <float> _values) {
    ...
    if (p_id == -1) {
        ...
        printf("Parameter: %s with target device type %d not allowed.", _name, _target_device); 
        fflush(stdout);
    }
...
init_activity_limits_list(){
    ...
    ACTIVITY_LIMITS_LIST[0] = ActivityLimits(
            ...
            ParamLimits("A_BT_SVC_MODE",      INVISIBLE,  DOG,    -1,    -1,   -1,   {}    ),
            ...
            ParamLimits("FOL_VEL_FF",         INTERVAL,   DOG,    0.1f,  2.0f, 0.2f, {}    ),
            ParamLimits("FOL_USE_ALT",        VALUES_STR, DOG,    -1,    -1,   -1,   {0,1} ),
            ParamLimits("FOL_RPT_ALT",        VALUES_STR, DOG,    -1,    -1,   -1,   {0,1} ),
            ParamLimits("FOL_VEL_FF",         INTERVAL,   DOG,    17.0f, 1.0f,  0.1f, {}    ),
            ParamLimits("MCP_XY_VEL_P",       INVISIBLE,  DOG,    -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_I",       INVISIBLE,  DOG,    -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_D",       INVISIBLE,  DOG,    -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_P",       INVISIBLE,  LEASH,  -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_I",       INVISIBLE,  LEASH,  -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_D",       INVISIBLE,  LEASH,  -1,    -1,   -1,   {}    ),
            ParamLimits("PAFOL_TRAJ_RAD",     INVISIBLE,  ALL,  -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_FF",          INVISIBLE,  DOG,    -1,    -1,   -1,   {}    ),
            });

    ACTIVITY_LIMITS_LIST[1] = ActivityLimits(
            1, 
            "KITEBOARDING", 
            {
            //    Param name            Type        Device   Istart Iend  Step  Values  
            ParamLimits("A_ACTIVITY",         INVISIBLE,  ALL,     -1,    -1,   -1,   {}    ), 
            ParamLimits("MCP_XY_VEL_D",       INVISIBLE,  LEASH,  -1,     -1,   -1,   {2.0f, 3.0f} ),
            ParamLimits("PAFOL_OPT_D",        VALUES_INT,   DOG,     12,    30,   1,    {10,15,30}    ),
            ParamLimits("FOL_VEL_FF",         VALUES_FLOAT,   DOG,     0.1f,  2.0f, 0.2f, {1.1f, 2.2f, 3.5f} ),
            });
    ...
    ACTIVITY_LIMITS_LIST[2] = ActivityLimits(
            ...
            ParamLimits("FOL_USE_ALT",        VALUES_STR, DOG,     -1,   -1,    -1,   {0,1} ),
            ParamLimits("FOL_RPT_ALT",        VALUES_STR, DOG,     -1,   -1,    -1,   {0,1} ),
            ParamLimits("FOL_VEL_FF",         INTERVAL,   DOG,     0.0f, 1.0f,  0.1f, {}    ),
            ParamLimits("MCP_XY_VEL_P",       INVISIBLE,  DOG,     -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_I",       INVISIBLE,  DOG,     -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_VEL_D",       INVISIBLE,  DOG,     -1,    -1,   -1,   {}    ),
            ParamLimits("MCP_XY_FF",          INVISIBLE,  DOG,     -1,    -1,   -1,   {}    ),
